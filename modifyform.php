                    ...
                    <table class="table table-striped">
                      <tr>
                       ...
                       <tr>
                        <td>패스워드</td>
                        <td>
                        <input type="password" value="<?php echo $row['password']?>" name="password_encrypted" class="form-control">
                        </td>
                      </tr>
            			</tr>
						<tr>
                      ...
                      <tr>
                        <td>전화</td>
                        <td>
                        <input type="tel" value="<?php echo $row['phone_number']?>" name="tel" class="form-control">
                        </td>
                      </tr>
