...
<input type="text" class="form-control" id="title"
 placeholder="제목 입력" name="title" value="연습용입니다." readonly
 maxlength="100" >
...
<textarea class="form-control" rows="20" id="content"
 name="content" placeholder="내용 작성" readonly>연습용 내용입니다.</textarea>
 </div>
    <button type="button" class="btn btn-default pull-right" onclick="location.href='/board.html'">글목록</button>
    <button type="button" class="btn btn-default pull-right" onclick="location.href='/writemodify.php'">수정</button>
